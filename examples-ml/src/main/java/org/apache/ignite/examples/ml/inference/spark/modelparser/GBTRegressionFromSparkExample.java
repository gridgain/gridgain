...
public class GBTRegressionFromSparkExample {
    ...
    public static final String SPARK_MDL_PATH = "examples-ml/src/main/resources/models/spark/serialized/gbtreg";

    /** Run example. */
    public static void main(String[] args) throws FileNotFoundException {
        System.out.println();
        System.out.println(">>> GBT Regression model loaded from Spark through serialization over partitioned " +
