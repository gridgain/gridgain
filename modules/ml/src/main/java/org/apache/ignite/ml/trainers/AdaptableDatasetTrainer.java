...
public class AdaptableDatasetTrainer<I, O, IW, OW, M extends IgniteModel<IW, OW>, L>
    ...
    /** {@inheritDoc} */
    @Override public <K, V> AdaptableDatasetModel<I, O, IW, OW, M> fitInitializedDeployingContext(DatasetBuilder<K, V> datasetBuilder,
    ...
    public AdaptableDatasetTrainer<I, O, IW, OW, M, L> withDatasetMapping(DatasetMapping<L, L> mapping) {
        return of(new DatasetTrainer<M, L>() {
            /** {@inheritDoc} */
            @Override public <K, V> M fitInitializedDeployingContext(DatasetBuilder<K, V> datasetBuilder, Preprocessor<K, V> extractor) {
