...
public class LearningEnvironmentBuilderTest {
    ...
    public void withLoggingFactory() {
        assertTrue(LearningEnvironmentBuilder.defaultBuilder()
            .withLoggingFactoryDependency(part -> ConsoleLogger.factory(MLLogger.VerboseLevel.HIGH))
        ...
        assertTrue(LearningEnvironmentBuilder.defaultBuilder()
            .withLoggingFactoryDependency(part -> CustomMLLogger.factory(new NullLogger()))
