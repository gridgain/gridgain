...
%PATH_TO_JDK_KEYTOOL% -import -alias cacrt -file ca.crt -storetype JKS -noprompt -storepass %PWD% -keystore server.jks
%PATH_TO_JDK_KEYTOOL% -import -alias cacrt -file ca.crt -storetype PKCS12 -noprompt -storepass %PWD% -keystore server.p12
