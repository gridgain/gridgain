...
keytool -import -alias cacrt -file ca.crt -storetype JKS -noprompt -storepass ${PWD} -keystore server.jks
keytool -import -alias cacrt -file ca.crt -storetype PKCS12 -noprompt -storepass ${PWD} -keystore server.p12
