...
package org.apache.ignite.internal.agent.action.annotation;
...
public class ActionControllerAnnotationReader {
    ...
    private static final Map<String, ActionMethod> methods = Collections.unmodifiableMap(
        findActionMethods(
            "org.apache.ignite.internal.agent.action.controller",
            "org.gridgain.internal.agent.action.controller")
    );
