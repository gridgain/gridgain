...
public class GUIConsole extends Console implements ActionListener, MouseListener, WindowListener {
    ...
    private boolean createTrayIcon() {
        try {
            ...
            if (d.width >= 24 && d.height >= 24) {
                iconFile = "/org/gridgain/internal/h2/res/h2-24.png";
                ...
                iconFile = "/org/gridgain/internal/h2/res/h2-64-t.png";
                // iconFile = "/org/gridgain/internal/h2/res/h2-22-t.png";
            } else {
                iconFile = "/org/gridgain/internal/h2/res/h2.png";
            }
    ...
    private void showStatusWindow() {
        ...
        Image image = loadImage("/org/gridgain/internal/h2/res/h2.png");
        if (image != null) {
