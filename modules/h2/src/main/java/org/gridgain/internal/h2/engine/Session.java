...
public class Session extends SessionWithState implements TransactionStore.RollbackListener {
    ...
    public void removeLocalTempTable(Table table) {
        // Exception thrown in org.gridgain.internal.h2.engine.Database.removeMeta if line below
    ...
    private void _cleanTempTables(boolean closeSession) {
        ...
        while (it.hasNext()) {
            ...
            if (closeSession || table.getOnCommitDrop()) {
                ...
                table.setModified();
                it.remove();
                // Exception thrown in org.gridgain.internal.h2.engine.Database.removeMeta
