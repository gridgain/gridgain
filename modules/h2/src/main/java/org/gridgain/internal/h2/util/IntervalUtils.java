...
public class IntervalUtils {
    ...
    public static StringBuilder appendInterval(StringBuilder buff, IntervalQualifier qualifier, boolean negative,
        ...
        case DAY_TO_SECOND: {
            ...
            remaining /= DateTimeUtils.NANOS_PER_MINUTE;
            buff.append(leading).append(' ');
            StringUtils.appendZeroPadded(buff, 2, remaining / 60);
            buff.append(':');
            StringUtils.appendZeroPadded(buff, 2, remaining % 60);
        ...
        case HOUR_TO_SECOND:
            buff.append(leading).append(':');
            StringUtils.appendZeroPadded(buff, 2, remaining / DateTimeUtils.NANOS_PER_MINUTE);
            buff.append(':');
            appendSecondsWithNanos(buff, remaining % DateTimeUtils.NANOS_PER_MINUTE);
            break;
        case MINUTE_TO_SECOND:
            buff.append(leading).append(':');
    ...
    private static void appendSecondsWithNanos(StringBuilder buff, long nanos) {
        StringUtils.appendZeroPadded(buff, 2, nanos / DateTimeUtils.NANOS_PER_SECOND);
        appendNanos(buff, nanos % DateTimeUtils.NANOS_PER_SECOND);
    }
