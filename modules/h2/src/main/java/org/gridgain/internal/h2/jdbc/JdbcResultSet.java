...
import org.gridgain.internal.h2.result.UpdatableRow;
...
public class JdbcResultSet extends TraceObject implements ResultSet, JdbcResultSetBackwardsCompat {
    ...
    private <T> T extractObjectOfType(Class<T> type, Value value) throws SQLException {
        ...
        if (type == BigDecimal.class) {
            ...
            return type.cast(value.getDate(null));
        } else if (type == Time.class) {
            return type.cast(value.getTime(null));
        } else if (type == Timestamp.class) {
            return type.cast(value.getTimestamp(null));
        } else if (type == java.util.Date.class) {
            return type.cast(new java.util.Date(value.getTimestamp(null).getTime()));
