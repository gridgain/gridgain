...
<div id="toolScript" style="display: none">
    ...
    <table class="tool">
        <tr><td>
        ${text.tools.sourceDatabaseURL}:&nbsp;</td><td><input id="optionScript.0" name="url" onkeyup="update()" onchange="update()" value="jdbc:gg-h2:~/test" size="50" />
        </td></tr><tr><td>
...
<div id="toolRunScript" style="display: none">
    ...
    <table class="tool">
        <tr><td>
        ${text.tools.targetDatabaseURL}:&nbsp;</td><td><input id="optionRunScript.0" name="url" onkeyup="update()" onchange="update()" value="jdbc:gg-h2:~/test" size="50" />
        </td></tr><tr><td>
...
<div id="toolCreateCluster" style="display: none">
    ...
    <table class="tool">
        <tr><td>
        ${text.tools.sourceDatabaseURL}:&nbsp;</td><td><input id="optionCreateCluster.0" name="urlSource" onkeyup="update()" onchange="update()" value="jdbc:gg-h2:~/test" size="50" />
        </td></tr><tr><td>
        ${text.tools.targetDatabaseURL}:&nbsp;</td><td><input id="optionCreateCluster.1" name="urlTarget" onkeyup="update()" onchange="update()" value="jdbc:gg-h2:~/copy/test" size="50" />
        </td></tr><tr><td>
...
<div id="commandLine" style="display: none">
        ...
        java -cp h2*.jar org.gridgain.internal.h2.tools.<span id="toolName"></span>
