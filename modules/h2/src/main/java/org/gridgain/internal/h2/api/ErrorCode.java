...
public class ErrorCode {
     ...
     * path, such as "jdbc:gg-h2:test" (in which case the database file would be
     ...
     * are used. Instead, use "jdbc:gg-h2:~/name" (relative to the current user
     * home directory), use an absolute path, set the base directory (baseDir),
     * use "jdbc:gg-h2:./name" (explicit relative path), or set the system property
     ...
     * <pre>
     * Connection conn;
     * conn = DriverManager.getConnection(&quot;jdbc:gg-h2:&tilde;/test&quot;);
     * conn = null;
     ...
     * <ul><li>In embedded mode (URL of the form jdbc:gg-h2:~/test) if all
     * connections are opened within the same process and class loader.
     * </li><li>In server and cluster mode (URL of the form
     * jdbc:gg-h2:tcp://localhost/test) using remote connections.
     * </li></ul>
     ...
     * Recovery tool (org.gridgain.internal.h2.tools.Recover).
     */
     ...
     *      CALL "org.gridgain.internal.h2.samples.TriggerSample$MyTrigger";
     * CREATE TRIGGER TRIGGER_A AFTER INSERT ON TEST
     *      CALL "org.gridgain.internal.h2.samples.TriggerSample$MyTrigger";
     * </pre>
     */
     ...
     * Example of wrong usage:
     * <pre>
     * String url = &quot;jdbc:gg-h2:&tilde;/test;CIPHER=AES&quot;;
    ...
    */
     ...
     * Example:
     * <pre>
     * jdbc:gg-h2:~/test;FILE_LOCK=LDAP
     * </pre>
     */
     ...
     * Example:
     * <pre>
     * jdbc:gg-h2:~/test;LOCK_TIMEOUT=0;LOCK_TIMEOUT=1
     * </pre>
     */
     ...
     * Example:
     * <pre>
     * jdbc:gg-h2:~/test;ACCESS_MODE_DATA=R
     * CREATE TABLE TEST(ID INT);
     * </pre>
     */
     ...
     * <pre>
     * jdbc:gg-h2:&tilde;/test;DATABASE_EVENT_LISTENER='java.lang.String'
     * </pre>
     */
     ...
     * <pre>
     * java org.gridgain.internal.h2.tools.Server -tcp -tcpAllowOthers
     * </pre>
     ...
     * Example of wrong usage:
     * <pre>
     * DriverManager.getConnection("jdbc:gg-h2:~/t");
     * DriverManager.getConnection("jdbc:gg-h2:~/test/");
     * </pre>
     * Correct:
     * <pre>
     * DriverManager.getConnection("jdbc:gg-h2:~/te");
     * DriverManager.getConnection("jdbc:gg-h2:~/test/te");
     * </pre>
     */
     ...
     * <pre>
     * jdbc:gg-h2:./database_that_does_not_exist
     * </pre>
     */
