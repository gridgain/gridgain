...
public class JdbcPreparedStatement extends JdbcStatement implements
    ...
    public ResultSet executeQuery() throws SQLException {
        try {
            int id = TraceObject.getNextId(TraceObject.RESULT_SET);
            if (isDebugEnabled()) {
    ...
    public void setString(int parameterIndex, String x) throws SQLException {
        try {
            if (isDebugEnabled()) {
                debugCode("setString("+parameterIndex+", "+ TraceObject.quote(x)+");");
            }
    ...
    public void setBigDecimal(int parameterIndex, BigDecimal x)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("setBigDecimal("+parameterIndex+", " + TraceObject.quoteBigDecimal(x) + ");");
            }
    ...
    public void setNull(int parameterIndex, int sqlType, String typeName)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("setNull("+parameterIndex+", "+sqlType+", "+ TraceObject.quote(typeName)+");");
            }
    ...
    public void setBytes(int parameterIndex, byte[] x) throws SQLException {
        try {
            if (isDebugEnabled()) {
                debugCode("setBytes("+parameterIndex+", "+ TraceObject.quoteBytes(x)+");");
            }
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        try {
            ...
            int id = TraceObject.getNextId(TraceObject.RESULT_SET_META_DATA);
            if (isDebugEnabled()) {
    ...
    public int executeUpdate(String sql, int autoGeneratedKeys)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("executeUpdate("+ TraceObject.quote(sql)+", "+autoGeneratedKeys+");");
            }
            throw DbException.get(ErrorCode.METHOD_NOT_ALLOWED_FOR_PREPARED_STATEMENT);
        } catch (Exception e) {
            throw logAndConvert(e);
    ...
    public long executeLargeUpdate(String sql, int autoGeneratedKeys)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("executeLargeUpdate("+ TraceObject.quote(sql)+", "+autoGeneratedKeys+");");
            }
            throw DbException.get(ErrorCode.METHOD_NOT_ALLOWED_FOR_PREPARED_STATEMENT);
        } catch (Exception e) {
            throw logAndConvert(e);
    ...
    public int executeUpdate(String sql, int[] columnIndexes)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("executeUpdate(" + TraceObject.quote(sql) + ", " +
                                TraceObject.quoteIntArray(columnIndexes) + ");");
            }
            throw DbException.get(ErrorCode.METHOD_NOT_ALLOWED_FOR_PREPARED_STATEMENT);
        } catch (Exception e) {
            throw logAndConvert(e);
    ...
    public long executeLargeUpdate(String sql, int[] columnIndexes)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("executeLargeUpdate(" + TraceObject.quote(sql) + ", " +
                                TraceObject.quoteIntArray(columnIndexes) + ");");
            }
            throw DbException.get(ErrorCode.METHOD_NOT_ALLOWED_FOR_PREPARED_STATEMENT);
        } catch (Exception e) {
    ...
    public int executeUpdate(String sql, String[] columnNames)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("executeUpdate(" + TraceObject.quote(sql) + ", " +
                                TraceObject.quoteArray(columnNames) + ");");
            }
    ...
    public boolean execute(String sql, int autoGeneratedKeys)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("execute(" + TraceObject.quote(sql) + ", " + autoGeneratedKeys + ");");
            }
            throw DbException.get(
                    ErrorCode.METHOD_NOT_ALLOWED_FOR_PREPARED_STATEMENT);
        } catch (Exception e) {
    ...
    public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        try {
            if (isDebugEnabled()) {
                debugCode("execute(" + TraceObject.quote(sql) + ", " + TraceObject.quoteIntArray(columnIndexes) + ");");
            }
            throw DbException.get(ErrorCode.METHOD_NOT_ALLOWED_FOR_PREPARED_STATEMENT);
        } catch (Exception e) {
            throw logAndConvert(e);
    ...
    public boolean execute(String sql, String[] columnNames)
        ...
        try {
            if (isDebugEnabled()) {
                debugCode("execute(" + TraceObject.quote(sql) + ", " + TraceObject.quoteArray(columnNames) + ");");
            }
            throw DbException.get(
                    ErrorCode.METHOD_NOT_ALLOWED_FOR_PREPARED_STATEMENT);
        } catch (Exception e) {
    ...
    public ParameterMetaData getParameterMetaData() throws SQLException {
        try {
            int id = TraceObject.getNextId(TraceObject.PARAMETER_META_DATA);
            if (isDebugEnabled()) {
    ...
    public void setNString(int parameterIndex, String x) throws SQLException {
        try {
            if (isDebugEnabled()) {
                debugCode("setNString("+parameterIndex+", "+ TraceObject.quote(x)+");");
            }
            Value v = x == null ? (Value) ValueNull.INSTANCE : ValueString.get(x);
            setParameter(parameterIndex, v);
        } catch (Exception e) {
