...
import org.gridgain.internal.h2.bnf.context.DbColumn;
import org.gridgain.internal.h2.bnf.context.DbContents;
import org.gridgain.internal.h2.bnf.context.DbSchema;
...
import org.gridgain.internal.h2.jdbc.JdbcException;
...
public class WebApp {
            ...
            if (e instanceof SQLException) {
                ...
                if (isH2) {
                    ...
                    error += " <a href=\"http://h2database.com/javadoc/" +
                            "org/gridgain/internal/h2/api/ErrorCode.html#c" + code +
                            "\">(${text.a.help})</a>";
                }
            }
    ...
    private static String linkToSource(String s) {
        try {
            ...
            while (true) {
                int start = s.indexOf("org.gridgain.internal.h2.", idx);
                if (start < 0) {
    ...
    private String test() {
        ...
        boolean isH2 = url.startsWith("jdbc:gg-h2:");
        try {
