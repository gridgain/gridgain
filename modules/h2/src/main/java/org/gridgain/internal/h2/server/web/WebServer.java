...
public class WebServer implements Service {
    ...
    private static final String[] GENERIC = {
        ...
        "Generic H2 (Server)|org.gridgain.internal.h2.Driver|" +
                "jdbc:gg-h2:tcp://localhost/~/test|sa",
        // this will be listed on top for new installations
        "Generic H2 (Embedded)|org.gridgain.internal.h2.Driver|" +
                "jdbc:gg-h2:~/test|sa",
    };
...
//                // "src/main/org/gridgain/internal/h2/server/web/res/_text_cs.prop"), -1);
//                "src/main/org/gridgain/internal/h2/res/_messages_cs.prop"), -1);
...
//    }
    ...
    byte[] getFile(String file) throws IOException {
        trace("getFile <" + file + ">");
        byte[] data = Utils.getResource("/org/gridgain/internal/h2/server/web/res/" + file);
        if (data == null) {
            trace(" null");
        } else {
...
//            }
    ...
    Connection getConnection(String driver, String databaseUrl, String user,
        ...
        if (databaseUrl.startsWith("jdbc:gg-h2:")) {
