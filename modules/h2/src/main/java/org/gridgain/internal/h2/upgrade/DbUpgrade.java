 ...
 */
package org.gridgain.internal.h2.upgrade;
...
public class DbUpgrade {
    ...
    static {
        UPGRADE_CLASSES_PRESENT = Utils.isClassPresent("org.gridgain.internal.h2.upgrade.v1_1.Driver");
    }
    ...
    private static Connection connectWithOldVersion(String url, Properties info)
            throws SQLException {
        url = "jdbc:gg-h2v1_1:" + url.substring("jdbc:gg-h2:".length()) +
    ...
    private static void upgrade(ConnectionInfo ci, Properties info)
        ...
        try {
            ...
            String oldUrl = "jdbc:gg-h2v1_1:" + name +
