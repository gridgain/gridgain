...
-->
    ...
    &nbsp;&nbsp; <a href="help.jsp?jsessionid=${sessionId}">${text.a.help}</a>
        ...
        <div id="url" style="display: none">
            ...
            <h3>Embedded</h3>
            <p>
            The URL <code>jdbc:gg-h2:~/test</code> means the database is stored in
            the user home directory in files starting with 'test'.
            Absolute locations like <code>jdbc:gg-h2:/data/db/test</code> are supported.
            ...
            <b>Warning</b>: if no path is used (for example jdbc:gg-h2:test),
            then the database is stored in the current working directory
            (the directory where the application was started).
            URLs of the form jdbc:gg-h2:data/test are relative to
            ...
            <p>
            The URL <code>jdbc:gg-h2:tcp://localhost/~/test</code> means connect
            ...
            <h4>In-Memory</h4>
            <p>
            The URL <code>jdbc:gg-h2:mem:test</code> means open an in-memory database
