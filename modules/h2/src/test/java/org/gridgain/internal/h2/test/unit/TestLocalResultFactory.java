...
public class TestLocalResultFactory extends TestBase {
    ...
    public void test() throws Exception {
        try (Connection conn = DriverManager.getConnection("jdbc:gg-h2:mem:localResultFactory;LOCAL_RESULT_FACTORY=\""
    ...
    public static class MyTestLocalResultFactory extends LocalResultFactory {
        ...
        @Override public LocalResult create(Session session, Expression[] expressions, int visibleColumnCount, boolean system) {
            COUNTER.incrementAndGet();
            return LocalResultFactory.DEFAULT.create(session, expressions, visibleColumnCount, system);
        }
