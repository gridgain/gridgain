...
public class TestDriver extends TestDb {
    ...
    private void testSettingsAsProperties() throws Exception {
        ...
        String url = getURL("jdbc:gg-h2:mem:driver", true);
    ...
    private void testDriverObject() throws Exception {
        ...
        assertTrue(DriverManager.getDriver("jdbc:gg-h2:~/test") == instance);
        Driver.unload();
        try {
            java.sql.Driver d = DriverManager.getDriver("jdbc:gg-h2:~/test");
            fail(d.toString());
