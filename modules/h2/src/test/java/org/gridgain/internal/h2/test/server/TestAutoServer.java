...
public class TestAutoServer extends TestDb {
    ...
    private void testUnsupportedCombinations() throws SQLException {
        String[] urls = {
                "jdbc:gg-h2:" + getTestName() + ";file_lock=no;auto_server=true",
                "jdbc:gg-h2:" + getTestName() + ";file_lock=serialized;auto_server=true",
                "jdbc:gg-h2:" + getTestName() + ";access_mode_data=r;auto_server=true",
                "jdbc:gg-h2:mem:" + getTestName() + ";auto_server=true"
        };
        for (String url : urls) {
    ...
    private void testAutoServer(boolean port) throws Exception {
        ...
        for (; i > 0; i--) {
            ...
            if (server != null) {
                ...
                u2 = "jdbc:gg-h2:tcp://" + server + "/" + key + u2;
