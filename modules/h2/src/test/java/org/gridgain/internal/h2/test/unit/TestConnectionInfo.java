...
public class TestConnectionInfo extends TestDb {
    ...
    private void testImplicitRelativePath() throws Exception {
        ...
        assertThrows(ErrorCode.URL_RELATIVE_TO_CWD, this).
            getConnection("jdbc:gg-h2:" + getTestName());
        assertThrows(ErrorCode.URL_RELATIVE_TO_CWD, this).
            getConnection("jdbc:gg-h2:data/" + getTestName());

        getConnection("jdbc:gg-h2:./data/" + getTestName()).close();
    ...
    private void testConnectInitError() throws Exception {
        assertThrows(ErrorCode.SYNTAX_ERROR_2, this).
                getConnection("jdbc:gg-h2:mem:;init=error");
        assertThrows(ErrorCode.IO_EXCEPTION_2, this).
                getConnection("jdbc:gg-h2:mem:;init=runscript from 'wrong.file'");
    }

    private void testConnectionInfo() {
        Properties info = new Properties();
        ConnectionInfo connectionInfo = new ConnectionInfo(
                "jdbc:gg-h2:mem:" + getTestName() +
                        ";LOG=2" +
        ...
        assertEquals("jdbc:gg-h2:mem:" + getTestName(),
