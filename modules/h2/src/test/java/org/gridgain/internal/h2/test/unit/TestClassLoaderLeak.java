...
public class TestClassLoaderLeak extends TestBase {
    ...
    public void test() throws Exception {
        ...
        DriverManager.registerDriver((Driver)
                Class.forName("org.gridgain.internal.h2.Driver").getDeclaredConstructor().newInstance());
        DriverManager.registerDriver((Driver)
                Class.forName("org.gridgain.internal.h2.upgrade.v1_1.Driver").getDeclaredConstructor().newInstance());
    }
    ...
    static void runTest() throws Exception {
        ...
        Class.forName("org.gridgain.internal.h2.upgrade.v1_1.Driver");
        Driver d1 = DriverManager.getDriver("jdbc:gg-h2:mem:test");
        Driver d2 = DriverManager.getDriver("jdbc:gg-h2v1_1:mem:test");
        Connection connection;
        connection = DriverManager.getConnection("jdbc:gg-h2:mem:test");
    ...
    private static class TestClassLoader extends URLClassLoader {
        ...
        public synchronized Class<?> loadClass(String name, boolean resolve)
            ...
            if (!name.contains(CLASS_NAME) && !name.startsWith("org.gridgain.internal.h2.")) {
