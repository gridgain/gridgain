...
public class TestSynth extends TestDb {
    ...
    public TestBase init(TestAll conf) throws Exception {
        ...
        // addDatabase("org.gridgain.internal.h2.Driver", "jdbc:gg-h2:synth;mode=hsqldb", "sa", "");

        // mode = POSTGRESQL;
        // addDatabase("org.postgresql.Driver", "jdbc:postgresql:test", "sa",
        // "sa");
        // addDatabase("org.gridgain.internal.h2.Driver", "jdbc:gg-h2:synth;mode=postgresql", "sa",
        // "");

        mode = H2_MEM;
        Driver.load();
        addDatabase("org.gridgain.internal.h2.Driver", "jdbc:gg-h2:mem:synth", "sa", "", true);
        addDatabase("org.gridgain.internal.h2.Driver", "jdbc:gg-h2:" +
                getBaseDir() + "/synth/synth", "sa", "", false);

        // addDatabase("com.mysql.jdbc.Driver", "jdbc:mysql://localhost/test",
        // "sa", "");
        // addDatabase("org.gridgain.internal.h2.Driver", "jdbc:gg-h2:synth;mode=mysql", "sa", "");

        // addDatabase("com.mysql.jdbc.Driver", "jdbc:mysql://localhost/test",
        // "sa", "");
        // addDatabase("org.ldbc.jdbc.jdbcDriver",
        // "jdbc:ldbc:mysql://localhost/test", "sa", "");
        // addDatabase("org.gridgain.internal.h2.Driver", "jdbc:gg-h2:memFS:synth", "sa", "");
