...
public class TestUpgrade extends TestDb {
    ...
    public boolean isEnabled() {
        ...
        if (!Utils.isClassPresent("org.gridgain.internal.h2.upgrade.v1_1.Driver")) {
            return false;
        }
        return true;
    }
    ...
    private void testLobs() throws Exception {
        deleteDb("upgrade");
        Connection conn;
        conn = DriverManager.getConnection("jdbc:gg-h2v1_1:" +
    ...
    private void testNoUpgradeOldAndNew() throws Exception {
        ...
        // Create old db
        Utils.callStaticMethod("org.gridgain.internal.h2.upgrade.v1_1.Driver.load");
        Connection connOld = DriverManager.getConnection("jdbc:gg-h2v1_1:" +
                getBaseDir() + "/upgradeOld;PAGE_STORE=FALSE" + additionalParametersOld);
        // Test auto server, too
        Connection connOld2 = DriverManager.getConnection("jdbc:gg-h2v1_1:" +
                getBaseDir() + "/upgradeOld;PAGE_STORE=FALSE" + additionalParametersOld);
        ...
        // Create new DB
        Connection connNew = DriverManager.getConnection("jdbc:gg-h2:" +
                getBaseDir() + "/upgrade" + additionalParametersNew);
        Connection connNew2 = DriverManager.getConnection("jdbc:gg-h2:" +
                getBaseDir() + "/upgrade" + additionalParametersNew);
        ...
        statNew.executeUpdate("CREATE LOCAL TEMPORARY LINKED TABLE " +
                "linkedTestOld('org.gridgain.internal.h2.upgrade.v1_1.Driver', 'jdbc:gg-h2v1_1:" +
        ...
        connNew = DriverManager.getConnection("jdbc:gg-h2:" +
                getBaseDir() + "/upgrade" + additionalParametersNew);
        statNew = connNew.createStatement();
        // Link to old DB with upgrade
        statNew.executeUpdate("CREATE LOCAL TEMPORARY LINKED TABLE " +
                "linkedTestOld('org.gridgain.internal.h2.Driver', 'jdbc:gg-h2:" +
    ...
    private void testIfExists() throws Exception {
        ...
        Connection connOld = DriverManager.getConnection(
                "jdbc:gg-h2v1_1:" + getBaseDir() + "/upgrade;PAGE_STORE=FALSE");
        // Test auto server, too
        ...
        Connection connOldViaNew = DriverManager.getConnection(
                "jdbc:gg-h2:" + getBaseDir() + "/upgrade;ifexists=true;MV_STORE=FALSE");
    ...
    private void testCipher() throws Exception {
        ...
        // Create old db
        Utils.callStaticMethod("org.gridgain.internal.h2.upgrade.v1_1.Driver.load");
        Connection conn = DriverManager.getConnection("jdbc:gg-h2v1_1:" +
        ...
        conn = DriverManager.getConnection("jdbc:gg-h2:" +
    ...
    public void deleteDb(String dbName) {
        ...
        try {
            Utils.callStaticMethod(
                    "org.gridgain.internal.h2.upgrade.v1_1.tools.DeleteDbFiles.execute",
