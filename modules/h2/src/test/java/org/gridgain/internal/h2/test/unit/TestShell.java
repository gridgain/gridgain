...
import org.gridgain.internal.h2.tools.Shell;
...
public class TestShell extends TestBase {
    ...
    public void test() throws Exception {
        ...
        shell.runTool("-url", "jdbc:gg-h2:mem:", "-driver", "org.gridgain.internal.h2.Driver",
    ...
    private void test(final boolean commandLineArgs) throws IOException {
        ...
        Task task = new Task() {
            ...
            public void call() throws Exception {
                try {
                    ...
                    if (commandLineArgs) {
                        shell.runTool("-url", "jdbc:gg-h2:mem:",
                                "-user", "sa", "-password", "sa");
                    } else {
                        shell.runTool();
                    }
        ...
        if (!commandLineArgs) {
            read("[Enter]");
            testOut.println("jdbc:gg-h2:mem:");
            read("URL");
            testOut.println("");
            read("Driver");
            testOut.println("sa");
