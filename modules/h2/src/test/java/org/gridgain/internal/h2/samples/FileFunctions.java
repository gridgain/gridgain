...
public class FileFunctions {
    ...
    public static void main(String... args) throws Exception {
        ...
        stat.execute("CREATE ALIAS READ_TEXT_FILE " +
                "FOR \"org.gridgain.internal.h2.samples.FileFunctions.readTextFile\" ");
        stat.execute("CREATE ALIAS READ_TEXT_FILE_WITH_ENCODING " +
                "FOR \"org.gridgain.internal.h2.samples.FileFunctions.readTextFileWithEncoding\" ");
        stat.execute("CREATE ALIAS READ_FILE " +
                "FOR \"org.gridgain.internal.h2.samples.FileFunctions.readFile\" ");
