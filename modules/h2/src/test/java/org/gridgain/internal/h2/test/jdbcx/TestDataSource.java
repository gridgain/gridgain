 ...
 */
package org.gridgain.internal.h2.test.jdbcx;
...
import org.gridgain.internal.h2.jdbcx.JdbcXAConnection;
...
//     }
    ...
    private void testDataSourceFactory() throws Exception {
        ...
        ref.add(new StringRefAddr("url", "jdbc:gg-h2:mem:"));
        ...
        assertEquals("jdbc:gg-h2:mem:", ds.getURL());
