 ...
 */
package org.gridgain.internal.h2.java;
...
public class JavaParser {
    ...
    private static String cleanPackageName(String name) {
        if (name.startsWith("org.gridgain.internal.h2.java.lang")
                || name.startsWith("org.gridgain.internal.h2.java.io")) {
            return name.substring("org.gridgain.internal.h2.".length());
        }
        return name;
    }
