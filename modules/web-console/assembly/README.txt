...
account.authentication.maxAttempts=Infinity # Specifies the maximum number of failed attempts allowed before preventing login.
...
account.authentication.maxInterval=300000 # Specifies the maximum amount of time an account can be locked (milliseconds).
