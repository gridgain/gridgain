...
public class MessageSourceConfiguration {
    ...
    @Bean
    @Primary
    public MessageSource notificationssMessages() {
        ReloadableResourceBundleMessageSource msgSrc = new WildcardReloadableResourceBundleMessageSource();

        msgSrc.setBasenames("classpath*:i18/*");
     ...
     *
     */
    private static class WildcardReloadableResourceBundleMessageSource extends ReloadableResourceBundleMessageSource {
        /**
