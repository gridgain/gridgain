            ...
            value: {
                properties: [
                    ...
                    },
                    {
                        ...
                        typeClsName: 'org.apache.ignite.cache.store.jdbc.JdbcType',
                        varArg: true
                    }
                ],
                arguments: [],
            ...
            items: [
                {
                    ...
                    src: {
                        ...
                        tableName: '',
                        fields: [
                            {name: 'id', className: 'Integer', notNull: true},
                            {name: 'value', className: 'Timestamp'}
                        ],
                        indexes: [
                            {
...
export const TEST_CONFIGURATION = {
    ...
    properties: [
        ...
        },
        {
            ...
            typeClsName: 'org.gridgain.grid.configuration.GridGainConfiguration',
            varArg: true
        }
    ],
    arguments: [],
...
export const TEST_CONFIGURATION_SIMPLE = {
    id: '63294d95-f9eb-4889-8dfd-d0598944f42d',
    name: 'Cluster Simple',
    discovery: {
        kind: 'Multicast',
        Vm: {addresses: ['127.0.0.1:47500..47510']},
    ...
    caches: [
        {
            id: '9e8f7fee-26db-4a4a-a35a-972e501255fe',
            cacheMode: 'PARTITIONED',
            atomicityMode: 'ATOMIC',
            name: 'Cache Simple'
        }
...
export const CACHE_LOAD_WO_PERSISTENCE_CONTENT = outdent`
...
export const CACHE_LOAD_WITH_PERSISTENCE_CONTENT = outdent`
public class TestClassName {
    /**
     * <p>
     * Utility to load caches from database.
