...
public class NotificationServiceTest {
    /** Mail service. */
    private IMailService mailSrvc = Mockito.mock(MailService.class);
    ...
    public void testSendNotification() throws Exception {
        ...
        NotificationService srvc = mockService("http://localhost/");
    ...
    /**
     * @param origin Web console url.
     */
    private NotificationService mockService(String origin) {
        return new NotificationService(mailSrvc, origin);
    }
}
