...
public class QueryParserMetricsHolder {
    ...
    public QueryParserMetricsHolder(GridMetricManager metricMgr) {
        ...
        this.qryCacheHits = registry.longAdderMetric("hits", "Number of hits for queries cache");
        this.qryCacheMisses = registry.longAdderMetric("misses", "Number of misses for queries cache");
    }
