 ...
 * H2 Row.
 */
public class GridH2Row extends GridH2ValueMessage {
    /** */
     ...
     */
    public GridH2Row(Value val) throws IgniteCheckedException {
        assert val.getType().getValueType() == Value.ROW : val.getType();

        ValueRow arr = (ValueRow)val;
    ...
    @Override public Value value(GridKernalContext ctx) throws IgniteCheckedException {
        return ValueRow.get(fillArray(x.iterator(), new Value[x.size()], ctx));
    }
    ...
    @Override public boolean readFrom(ByteBuffer buf, MessageReader reader) {
        ...
        return reader.afterMessageRead(GridH2Row.class);
    }
