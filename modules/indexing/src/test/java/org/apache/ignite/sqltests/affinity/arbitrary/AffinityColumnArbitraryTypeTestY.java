...
public class AffinityColumnArbitraryTypeTestY extends AbstractAffinityColumnTest {
    ...
    public void testInsert() throws Exception {
        ...
        IgniteDataStreamer<BinaryObject, BinaryObject> streamer = getProtectionInstrumentStreamer(ignite(0));
        IgniteBiTuple<BinaryObject, BinaryObject> row = jsonData(ignite(0));
        streamer.addData(row.getKey(), row.getValue());

        //BinaryObject key = ignite(0).binary().builder("ACME_KEY")
        //    .setField("ContractId", 151)
        //    .setField("SEQUENCEKEY", 151)
        //    .build();
        //streamer.addData(key, row.getValue());
        streamer.close();
        ...
        ignite(0).cache("test").query(new SqlFieldsQuery("" +
            ...
            ") values (" +
            "   152," +
            //"   '210|AAPIBW|AAPPEGX8|2010|02|07', " +
            //"   '210|AAPIBW|AAPPEGX7', " +
            //"   '210', " +
            "   152, " +
            "   'AAPIBW', " +
    ...
    public static IgniteBiTuple<BinaryObject, BinaryObject> jsonData(Ignite ignite) {
        String key = "{\"schema\":{\"name\":\"ACME_KEY\",\"optional\":true,\"type\":\"struct\",\"fields\":[" +
            ...
            "]},\"payload\":{\"ContractId\":150,\"SEQUENCEKEY\":150}}";
    ...
    public static void createTable(Ignite ignite) {
        ignite.cache("test").query(new SqlFieldsQuery("CREATE TABLE ProtectionInstrument(\n" +
            ...
            ") WITH \"CACHE_NAME=YOHOHO, KEY_TYPE=ACME_KEY,\n" +
