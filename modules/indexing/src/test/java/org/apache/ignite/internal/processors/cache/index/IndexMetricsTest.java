...
public class IndexMetricsTest extends AbstractIndexingCommonTest {
    ...
    /**
     * Checking correctness of index rebild metrics.
     * <p/>
     * Steps:
     * 1)I start a node with 2 caches and fill them;
     * 2)Restarting node with deletion index.bin to start rebuilding indexes, stop rebuilding indexes for two caches;
     * 3)Check that they are in process of rebuilt and no rebuild keys;
     * 4)Release first cache, wait for it to finish rebuilding, and check that all keys have been rebuilt
     * and rebuilding is over, and second one is still in progress;
