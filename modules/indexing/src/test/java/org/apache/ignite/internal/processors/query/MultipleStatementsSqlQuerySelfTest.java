    ...
    public void testCorrectWithLazy() {
        ...
        SqlFieldsQuery qry = new SqlFieldsQuery(
            "DROP TABLE IF EXISTS CITY;\n" +
                ...
                ");" +
                "" +
                "INSERT INTO City(ID, Name, CountryCode, District, Population, TimeS) VALUES " +
                "(1,'Kabul','AFG','Kabol',1780000, CURRENT_TIMESTAMP());\n" +
                "INSERT INTO City(ID, Name, CountryCode, District, Population, TimeS) VALUES " +
                "(2,'Qandahar','AFG','Qandahar',237500, CURRENT_TIMESTAMP());\n" +
                "SELECT * FROM City;" +
                "SELECT * FROM City;" +
