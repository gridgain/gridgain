 ...
 */
public class GridLucene8IndexFactory implements LuceneIndexFactory {
    /** Context. */
     ...
     * @param ctx Context.
     */
    public GridLucene8IndexFactory(GridKernalContext ctx) {
        this.ctx = ctx;
        this.log = ctx.log(GridLucene8IndexFactory.class);
