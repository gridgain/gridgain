...
public final class IgniteLogicalWindow extends Window implements IgniteRel {
  public IgniteLogicalWindow(RelOptCluster cluster, RelTraitSet traitSet,
      RelNode input, List<RexLiteral> constants, RelDataType rowType,
      List<Group> groups) {
    super(cluster, traitSet, input, constants, rowType, groups);
  }

  @Override public IgniteLogicalWindow copy(RelTraitSet traitSet,
      List<RelNode> inputs) {
    return new IgniteLogicalWindow(getCluster(), traitSet, sole(inputs), constants,
      rowType, groups);
  }

  public static IgniteLogicalWindow create(RelTraitSet traitSet, RelNode input,
      List<RexLiteral> constants, RelDataType rowType, List<Group> groups) {
    return new IgniteLogicalWindow(input.getCluster(), traitSet, input, constants,
        rowType, groups);
  }
  ...
  public static RelNode create(RelOptCluster cluster,
    ...
    final IgniteLogicalWindow window =
        IgniteLogicalWindow.create(traitSet, child, constants, intermediateRowType,
            groups);
