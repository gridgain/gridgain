...
public class IgniteLogicalMatch extends Match implements IgniteRel {
  private IgniteLogicalMatch(RelOptCluster cluster, RelTraitSet traitSet,
  ...
  public static IgniteLogicalMatch create(RelNode input, RelDataType rowType,
    ...
    return new IgniteLogicalMatch(cluster, traitSet, input, rowType, pattern,
  ...
  @Override public Match copy(RelNode input, RelDataType rowType,
      ...
      boolean allRows, List<RexNode> partitionKeys, RelCollation orderKeys,
      RexNode interval) {
    final RelTraitSet traitSet = getCluster().traitSetOf(IgniteRel.LOGICAL_CONVENTION);
    return new IgniteLogicalMatch(getCluster(), traitSet,
        input,
        rowType,
