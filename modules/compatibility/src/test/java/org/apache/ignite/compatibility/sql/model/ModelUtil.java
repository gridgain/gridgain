...
public final class ModelUtil {
     ...
     *
     * Note: Copy-pasted from {@link GridTestUtils#randomString(Random, int, int)}. Apache Ignite doesn't have this,
     * hence we have to provide a way to generate random string that would be common for both AI and GG.
     *
