...
| 9  | Native AOT support                                                           | Smaller, faster-starting binaries; enables cloud-native and container scenarios.                 | Yes                                                                                         |
| 10 | ADO.NET provider                                                             | Integration with the standard .NET data-access ecosystem (Dapper, reporting tools, etc.).        | Yes                                                                                         |
| 11 | EF Core integration                                                          | First-class ORM support for .NET applications.                                                   | In progress (GG9 implementation mostly ready, not yet released — high code-reuse potential) |
| 12 | Source-generated serializers                                                 | Faster startup and throughput; improves AOT scenarios.                                           | Pending                                                                                     |
