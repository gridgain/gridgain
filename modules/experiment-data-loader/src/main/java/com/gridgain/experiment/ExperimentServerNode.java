...
public class ExperimentServerNode {
    public static void main(String[] args) throws Exception {
        String[][] sqls = {
            ...
            {
                "All integer and long columns",
                "select abbr7_submsn_dt, abbr7_line_from_dt, abbr7_line_thru_dt, abbr7_from_dt, abbr7_thru_dt, abbr7_actv_care_from_dt, abbr7_dschrg_dt, abbr7_ocrnc_span_1_from_dt, abbr7_ocrnc_span_1_to_dt, abbr7_ocrnc_span_2_from_dt, abbr7_ocrnc_span_2_to_dt, abbr7_ocrnc_span_3_from_dt, abbr7_ocrnc_span_3_to_dt, abbr7_ocrnc_span_4from_dt, abbr7_ocrnc_span_4_to_dt, abbr7_ocrnc_span_5_from_dt, abbr7_ocrnc_span_5_to_dt, abbr7_ocrnc_span_6_from_dt, abbr7_ocrnc_span_6_to_dt, abbr7_ocrnc_span_7_from_dt, abbr7_ocrnc_span_7_to_dt, abbr7_ocrnc_span_8_from_dt, abbr7_ocrnc_span_8_to_dt, abbr7_ocrnc_span_9_from_dt, abbr7_ocrnc_span_9_to_dt, abbr7_ocrnc_span_10_from_dt, abbr7_ocrnc_span_10_to_dt, abbr7_insrd_birth_dt, abbr7_ptnt_death_dt, abbr7_idr_ld_dt, abbr7_line_instnl_rev_ctr_dt, abbr7_pd_dt, abbr7_bill_clsfctn_cd from abbr5"
            },
            {
                "First long column",
                "select abbr7_actv_care_from_dt from abbr5"
            },
            {
                "Long column in the middle",
                "select abbr7_ocrnc_span_2_to_dt from abbr5"
            },
            {
                "Last long column",
                "select abbr7_thru_dt from abbr5"
            },
            {
                "First string column",
                "select abbr1_1_mdfr_cd from abbr5"
            },
            {
                "String column in the middle",
                "select abbr7_fac_prvdr_zip5_cd from abbr5"
            },
            {
                "Last string column",
                "select sub_bid_ind from abbr5"
            },
            {
                "First 5 string columns",
                "select abbr1_1_mdfr_cd, abbr1_2_mdfr_cd, abbr1_3_mdfr_cd, abbr1_4_mdfr_cd, abbr1_5_mdfr_cd from abbr5"
            },
            {
                "Last 5 string columns",
                "select abbr8_hic_num, abbr8_ptnt_stus_cd, abbr8_rrb_num, prvdr_mdcr_id, sub_bid_ind from abbr5"
            },
            {
                "Scattered 20 string columns",
                "select abbr1_1_mdfr_cd, abbr7_abbr6_file_name, abbr7_admsn_type_cd, abbr7_bill_freq_cd, abbr7_blg_prvdr_oscar_num, abbr7_cwf_rqst_rec_id, abbr7_dgns_14_cd, abbr7_dgns_19_cd, abbr7_dgns_23_cd, abbr7_dgns_4_cd, abbr7_dgns_9_cd, abbr7_fac_prvdr_emer_ind, abbr7_fac_prvdr_zip5_cd, abbr7_line_dgns_cd, abbr7_line_pos_city_name, abbr7_line_pos_state_cd, abbr7_mbi, abbr7_ocrnc_span_4_cd, abbr7_ocrnc_span_9_cd, abbr7_pckp_zip5_cd from abbr5"
            },
        };
            ...
            for (String[] tup : sqls) {
                try {
                    ...
                    for (int i = 0; i < iters; i++) {
                        ...
                        for (List<?> row : cache.query(new SqlFieldsQuery(tup[1]).setLazy(true)))
                            cnt += row.size();

                        long t1 = System.currentTimeMillis();
                        System.err.println(tup[0] + " Time: " + (t1 - t0));
