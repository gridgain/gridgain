...
public class TxPartitionCounterStateConsistencyFuzzTest extends TxPartitionCounterStateAbstractTest {
    ...
    public void testSingleThreadedUpdateOrder() throws Exception {
        ...
        cache.put(keys.get(0), new TxPartitionCounterStateConsistencyFuzzTest.TestVal(keys.get(0)));
        ops.add(new T2<>(keys.get(0), op));

        cache.put(keys.get(1), new TxPartitionCounterStateConsistencyFuzzTest.TestVal(keys.get(1)));
        ops.add(new T2<>(keys.get(1), op));

        cache.put(keys.get(2), new TxPartitionCounterStateConsistencyFuzzTest.TestVal(keys.get(2)));
