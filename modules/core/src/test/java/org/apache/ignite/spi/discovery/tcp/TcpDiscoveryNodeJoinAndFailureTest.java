...
public class TcpDiscoveryNodeJoinAndFailureTest extends GridCommonAbstractTest {
     ...
     *
     * @see <a href="https://issues.apache.org/jira/browse/IGNITE-11621">IGNITE-11621</a> with comments provides detailed
     * description of this corner case.
     *
    ...
    public void testConnectingNodesStopIfNoConnectedNodeIsPresented() throws Exception {
        ...
        try {
            ...
            assertTrue("Expected error message was not found: " + errorMsg,
