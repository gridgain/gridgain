...
public class RebalanceIteratorLargeEntriesOOMTest extends GridCommonAbstractTest {
    ...
    // If we override only {@code RebalanceIteratorLargeEntriesOOMTest.isRemoteJvm} here, awaitPartitionMapExchange will
    // fail due to only {@code RebalanceIteratorLargeEntriesOOMTest.isMultiJvm} verification.
    /** {@inheritDoc} */
