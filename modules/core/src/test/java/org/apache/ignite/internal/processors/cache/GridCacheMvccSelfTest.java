...
public class GridCacheMvccSelfTest extends GridCommonAbstractTest {
    ...
    public void testNearRemoteWithOwned() {
        ...
        GridCacheMvccCandidate c1 = entry.addRemote(node1, 1, ver1);
        GridCacheMvccCandidate c2 = entry.addRemote(node1, 1, ver2);
        GridCacheMvccCandidate c3 = entry.addRemote(node1, 1, ver3);
        GridCacheMvccCandidate c4 = entry.addRemote(node1, 1, ver4);
    ...
    public void testNearRemoteWithOwned1() {
        ...
        GridCacheMvccCandidate c3 = entry.addRemote(node1, 1, ver3);
        GridCacheMvccCandidate c4 = entry.addRemote(node1, 1, ver4);
        GridCacheMvccCandidate c5 = entry.addRemote(node1, 1, ver5);
        GridCacheMvccCandidate c6 = entry.addRemote(node1, 1, ver6);
    ...
    public void testNearRemoteWithOwned2() {
        ...
        GridCacheMvccCandidate c0 = entry.addRemote(node1, 1, ver0);
        GridCacheMvccCandidate c1 = entry.addRemote(node1, 1, ver1);
        GridCacheMvccCandidate c2 = entry.addRemote(node1, 1, ver2);
        GridCacheMvccCandidate c3 = entry.addRemote(node1, 1, ver3);
        GridCacheMvccCandidate c4 = entry.addRemote(node1, 1, ver4);
    ...
    public void testLocal() {
        ...
        checkLocalOwner(entry.anyOwner(), ver3);
        ...
        // Check order.
        checkOrder(entry.localCandidates(), ver3, ver5);

        entry.removeLock(ver3);

        assert entry.localCandidates().size() == 1;

        checkLocalOwner(entry.anyOwner(), ver5);
        ...
        assert entry.anyOwner() == null;
        assert entry.localCandidates().isEmpty();
    }
    ...
    public void testCompletedWithBaseInTheMiddle() {
        ...
        entry.addRemote(node1, 1, ver1);
        entry.addRemote(node2, 2, ver2);
        entry.addRemote(node1, 3, ver3);
        entry.addRemote(node2, 4, ver4);
        entry.addRemote(node1, 5, ver5);
        entry.addRemote(node2, 7, ver7);
        entry.addRemote(node2, 8, ver8);

        GridCacheMvccCandidate doomed = entry.addRemote(node2, 6, ver6);
    ...
    public void testCompletedWithCompletedBaseInTheMiddle() {
        ...
        entry.addRemote(node2, 4, ver4);
        entry.addRemote(node1, 5, ver5);
        entry.addRemote(node2, 6, ver6);
        entry.addRemote(node2, 7, ver7);

        List<GridCacheVersion> committed = Arrays.asList(ver4, ver6, ver2);

        entry.orderCompleted(ver2, committed, Collections.emptyList());
    ...
    public void testCompletedTwiceWithBaseInTheMiddle() {
        ...
        entry.orderCompleted(ver2, completed, Collections.emptyList());

        checkOrder(entry.remoteMvccSnapshot(), ver1, ver4, ver6, ver2, ver3, ver5, ver7);

        entry.orderCompleted(ver4, completed, Collections.emptyList());
    ...
    public void testCompletedWithBaseInTheMiddleNoChange() {
        ...
        entry.orderCompleted(ver4, committed, Collections.emptyList());
    ...
    public void testCompletedWithBaseInTheBeginning() {
        ...
        entry.orderCompleted(ver1, committed, Collections.emptyList());
    ...
    public void testCompletedWithBaseInTheEndNoChange() {
        ...
        entry.orderCompleted(ver5, committed, Collections.emptyList());
    ...
    public void testCompletedWithBaseNotPresentInTheBeginningNoChange() {
        ...
        entry.addRemote(node2, 4, ver4);
        entry.addRemote(node1, 5, ver5);
        entry.addRemote(node1, 6, ver6);
        entry.addRemote(node1, 7, ver7);
    ...
    public void testLocalAndRemote() {
        ...
        checkOrder(cands, ver1, ver5);
        checkOrder(entry.localCandidates(), ver2);

        entry.addRemote(node1, 3, ver3);
        entry.addLocal(4, ver4, 0);
        ...
        checkLocalOwner(entry.anyOwner(), ver2);
        ...
        checkLocalOwner(entry.anyOwner(), ver4);
    ...
    public void testMultipleLocalAndRemoteLocks1() throws Exception {
        ...
        GridCacheMvccCandidate c13 = entry1.addLocal(1, ver3, 0);

        entry1.readyLocal(ver3);

        checkLocalOwner(entry1.candidate(ver3), ver3);

        GridCacheMvccCandidate c11 = entry1.addLocal(2, ver1, 0);
        GridCacheMvccCandidate c21 = entry2.addLocal(2, ver1, 0);
        GridCacheMvccCandidate c31 = entry3.addLocal(2, ver1, 0);

        GridCacheMvccCandidate c33 = entry3.addLocal(1, ver3, 0);
        ...
        entry2.addRemote(nodeId, 3, ver2);

        checkLocal(entry2.candidate(ver1), ver1, true, false, false);

        entry3.addRemote(nodeId, 3, ver2);
    ...
    public void testMultipleLocalAndRemoteLocks2() throws Exception {
        ...
        GridCacheMvccCandidate c11 = entry1.addLocal(2, ver2, 0);
        GridCacheMvccCandidate c21 = entry2.addLocal(2, ver2, 0);
        GridCacheMvccCandidate c31 = entry3.addLocal(2, ver2, 0);
        ...
        entry2.addRemote(UUID.randomUUID(), 3, ver1);

        checkLocal(entry2.candidate(ver2), ver2, true, false, false);

        entry3.addRemote(UUID.randomUUID(), 3, ver1);
    ...
    public void testMultipleLocalLocks() throws Exception {
        ...
        GridCacheMvccCandidate c23 = entry2.addLocal(1, ver3, 0);

        linkCandidates(ctx, c13, c23);

        entry2.readyLocal(ver3);

        checkLocalOwner(entry2.candidate(ver3), ver3);
    }
     ...
     */
    @Test
    public void testUsedCandidates() {
        GridCacheAdapter<String, String> cache = grid.internalCache(DEFAULT_CACHE_NAME);
        ...
        GridCacheMvccCandidate c1 = entry.addLocal(1, ver1, 0);

        ctx.mvcc().addNext(ctx, c1);

        ctx.mvcc().contextReset();

        GridCacheMvccCandidate c2 = entry.addLocal(2, ver2, 0);

        ctx.mvcc().addNext(ctx, c2);

        ctx.mvcc().contextReset();

        GridCacheMvccCandidate c3 = entry.addLocal(3, ver3, 0);
        ...
        checkLocal(c2, ver2, false, false, true);
        ...
        GridCacheMvccCandidate c4 = entry.addLocal(4, ver4, 0);
    ...
    public void testReverseOrder1() {
        ...
        GridCacheMvccCandidate c1k1 = entry1.addLocal(2, ver2, 0);
        ...
        GridCacheMvccCandidate c2k1 = entry1.addRemote(id, 2, ver1);
        ...
        GridCacheMvccCandidate c1k2 = entry2.addLocal(2, ver2, 0);
        ...
        GridCacheMvccCandidate c2k2 = entry2.addRemote(id, 3, ver1);
    ...
    public void testReverseOrder2() throws Exception {
        ...
        GridCacheMvccCandidate v3k1 = entry1.addLocal(3, ver3, 0);
        GridCacheMvccCandidate v3k2 = entry2.addLocal(3, ver3, 0);
        ...
        // Remote locks.
        GridCacheMvccCandidate v2k1 = entry1.addRemote(id, 3, ver2);
        GridCacheMvccCandidate v2k2 = entry2.addRemote(id, 3, ver2);

        checkRemote(v2k1, ver2, false, false);
        checkRemote(v2k2, ver2, false, false);

        // Local with lower version.
        GridCacheMvccCandidate v1k1 = entry1.addLocal(4, ver1, 0);
        GridCacheMvccCandidate v1k2 = entry2.addLocal(4, ver1, 0);
    ...
    public void testReverseOrder4() throws Exception {
        ...
        GridCacheMvccCandidate v2k2 = entry2.addRemote(id, 5, ver2);
