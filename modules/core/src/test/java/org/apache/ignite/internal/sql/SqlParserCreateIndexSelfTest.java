...
public class SqlParserCreateIndexSelfTest extends SqlParserAbstractSelfTest {
    ...
    public void testCreateIndex() throws Exception {
        ...
        assertParseError(null, "CREATE INDEX idx ON tbl(a DESC) PARALLEL ",
        ...
        assertParseError(null, "CREATE INDEX idx ON tbl(a DESC) PARALLEL -2",
            "Failed to parse SQL statement \"CREATE INDEX idx ON tbl(a DESC) PARALLEL -[*]2\": " +
                "Illegal PARALLEL value. Should be positive: -2");
        ...
        assertParseError(null, "CREATE INDEX ON tbl(a) INLINE_SIZE -1",
            "Failed to parse SQL statement \"CREATE INDEX ON tbl(a) INLINE_SIZE -[*]1\": " +
                "Illegal INLINE_SIZE value. Should be positive: -1");
        ...
        parseValidate(null, "CREATE INDEX idx ON schema.tbl(a) INLINE_SIZE 5 PARALLEL 7",
            "SCHEMA", "TBL", "IDX", getProps(7, 5), "A", false);
        parseValidate(null, "CREATE INDEX idx ON schema.tbl(a) PARALLEL 3 INLINE_SIZE 9 ",
            "SCHEMA", "TBL", "IDX", getProps(3, 9), "A", false);

        assertParseError(null, "CREATE INDEX idx ON schema.tbl(a) PARALLEL 3 INLINE_SIZE 9 PARALLEL 2",
            "Failed to parse SQL statement \"CREATE INDEX idx ON schema.tbl(a) PARALLEL 3 INLINE_SIZE [*]9 PARALLEL 2\": " +
                "Only one PARALLEL clause may be specified.");
        assertParseError(null, "CREATE INDEX idx ON schema.tbl(a) PARALLEL 3 INLINE_SIZE 9 abc ",
            "Failed to parse SQL statement \"CREATE INDEX idx ON schema.tbl(a) PARALLEL 3 INLINE_SIZE 9 [*]abc \": " +
                "Unexpected token: \"ABC\"");
        assertParseError(null, "CREATE INDEX idx ON schema.tbl(a) PARALLEL  INLINE_SIZE 9 abc ",
        ...
        assertParseError(null, "CREATE INDEX idx ON schema.tbl(a) PARALLEL 3 INLINE_SIZE abc ",
            "Failed to parse SQL statement \"CREATE INDEX idx ON schema.tbl(a) PARALLEL 3 INLINE_SIZE [*]abc \": " +
                "Unexpected token: \"ABC\" (expected: \"[integer]\")");
