...
public class SecurityPermissionSetBuilderTest extends GridCommonAbstractTest {
    ...
    public void testPermissionBuilder() {
        ...
        assertThrows(log, new Callable<Object>() {
                ...
                "you can assign permission only start with [EVENTS_, ADMIN_, CACHE_CREATE, CACHE_DESTROY, JOIN_AS_SERVER, SET_QUERY_MEMORY_QUOTA], but you try TASK_EXECUTE"
        );
        ...
        assertThrows(log, new Callable<Object>() {
            ...
            "you can assign permission only start with [EVENTS_, ADMIN_, CACHE_CREATE, CACHE_DESTROY, JOIN_AS_SERVER, SET_QUERY_MEMORY_QUOTA], but you try SERVICE_INVOKE"
        );
