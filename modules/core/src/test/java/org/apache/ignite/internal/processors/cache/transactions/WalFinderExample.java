...
public class WalFinderExample {
    public static JdkMarshaller marshaller = new JdkMarshaller();

    public static final String walDir1 = "C:\\projects\\cntr-alpha0\\1540456357723\\node1\\wal\\1540456359817";
    public static final String walDir2 = "C:\\projects\\cntr-alpha0\\1540456357723\\node2\\wal\\1540456359925";

    public static final int grpId = CU.cacheId("CACHEGROUP_DICTIONARY");
    public static final int partId = 60;
    ...
    public static void main(String[] args) {
        ...
        parseWalFilesTx(walDir1);
        parseWalFilesTx(walDir2);
    }
...
//                else
    ...
    public static String[] cacheNames = {
        "com.sbt.api.entities.out.IPublishedActivitySign"
    };
}
