...
import org.apache.ignite.internal.processors.cache.persistence.wal.WalArchiveSizeTest;
...
public class IgnitePdsTestSuite {
    ...
    public static List<Class<?>> suite(Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, WalArchiveSizeTest.class, ignoredTests);
