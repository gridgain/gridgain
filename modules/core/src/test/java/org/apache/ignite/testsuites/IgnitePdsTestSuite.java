...
import org.apache.ignite.internal.processors.cache.persistence.db.IgnitePdsWithTtlDeferredDeleteOnRestartTest;
...
public class IgnitePdsTestSuite {
    ...
    public static void addRealPageStoreTests(List<Class<?>> suite, Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, IgnitePdsWithTtlDeferredDeleteOnRestartTest.class, ignoredTests);
