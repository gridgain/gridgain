...
import org.apache.ignite.internal.processors.cache.distributed.CacheRebalanceThreadsUtilizationTest;
...
public class IgniteCacheTestSuite8 {
    ...
    public static List<Class<?>> suite(Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, CacheRebalanceThreadsUtilizationTest.class, ignoredTests);
