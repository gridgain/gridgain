...
public class CacheMessageStatsTest extends GridCommonAbstractTest {
    ...
    @Override protected void beforeTestsStarted() throws Exception {
        System.setProperty(IgniteSystemProperties.IGNITE_MESSAGE_STATS_ENABLED, "false");
    ...
    @Override protected void afterTestsStopped() throws Exception {
        ...
        System.clearProperty(IgniteSystemProperties.IGNITE_MESSAGE_STATS_ENABLED);
    ...
    private static class MyInvoke implements CacheEntryProcessor<Object, Object, char[]> {
        /** {@inheritDoc} */
        @Override public char[] process(
            MutableEntry<Object, Object> entry, Object... arguments) throws EntryProcessorException {
