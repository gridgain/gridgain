...
public class RebalanceEvictionTest extends GridCommonAbstractTest {

    private static final int NODES_CNT = 2;
    private static final int PARTS_CNT = 1;
    ...
    public void noEvictionOnRebalanceTest() throws Exception {
        execute((cache, writer) -> {
            LogListener lsnr = listener("Start clearAll() for part=0");

            stopGrid(0);
            writer.deleteFrom(0, 10);
            U.sleep(TS_CLEANUP);
            startGrid(0);
