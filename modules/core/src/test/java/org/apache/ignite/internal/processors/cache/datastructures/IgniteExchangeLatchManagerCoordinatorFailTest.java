...
import static org.apache.ignite.internal.processors.cache.distributed.dht.preloader.GridDhtPartitionsExchangeFuture.DISTRIBUTED_LATCH_ID;
            ...
            @Override public boolean apply(ClusterNode node, Message msg) {
                if (msg instanceof LatchAckMessage && node.order() == 3) {
                    ...
                    return ackMsg.topVer().equals(new AffinityTopologyVersion(6, 0)) &&
                        ackMsg.latchId().equals(DISTRIBUTED_LATCH_ID);
                }
