...
import org.apache.ignite.internal.processors.cache.persistence.db.checkpoint.CheckpointOnNodeStopTest;
...
public class IgnitePdsTestSuite6 {
    ...
    public static List<Class<?>> suite(Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, CheckpointOnNodeStopTest.class, ignoredTests);
