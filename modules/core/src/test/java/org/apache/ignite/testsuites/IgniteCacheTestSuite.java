...
import org.apache.ignite.cache.store.jdbc.MariaDBCacheStoreTest;
import org.apache.ignite.cache.store.jdbc.MariaDBCacheStoreWriteBehindTest;
...
public class IgniteCacheTestSuite {
    ...
    public static List<Class<?>> suite(Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, MariaDBCacheStoreTest.class, ignoredTests);
        GridTestUtils.addTestIfNeeded(suite, MariaDBCacheStoreWriteBehindTest.class, ignoredTests);
