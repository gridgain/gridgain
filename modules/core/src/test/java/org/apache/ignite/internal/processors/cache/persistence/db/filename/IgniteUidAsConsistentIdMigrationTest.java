...
public class IgniteUidAsConsistentIdMigrationTest extends GridCommonAbstractTest {
    ...
    private void deleteWorkFiles() throws IgniteCheckedException {
        ...
        ok &= U.delete(U.resolveWorkDirectory(U.defaultWorkDirectory(), DataStorageConfiguration.BINARY_METADATA_DFLT_PATH, false));
    ...
    public void testNewStyleIdIsGeneratedInCustomStorePath() throws Exception {
        ...
        assertDirectoryExist(DataStorageConfiguration.BINARY_METADATA_DFLT_PATH, subfolderName);
