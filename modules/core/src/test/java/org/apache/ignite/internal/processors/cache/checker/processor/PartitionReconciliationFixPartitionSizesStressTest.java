...
public class PartitionReconciliationFixPartitionSizesStressTest extends PartitionReconciliationAbstractTest {
    ...
    public static List<Object[]> parameters() {
        ...
        params.add(new Object[] {3, 0, 3000, ATOMIC, PARTITIONED, 0, 10, null, 100, 1, 8, false});
        ...
        params.add(new Object[] {4, 0, 3000, TRANSACTIONAL, PARTITIONED, 2, 14, null, 10, 3, 8, false});
        ...
        params.add(new Object[] {4, 0, 10000, ATOMIC, REPLICATED, 0, 12, null, 1, 10, 8, false});
