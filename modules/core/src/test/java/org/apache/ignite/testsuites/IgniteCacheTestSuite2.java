...
import org.apache.ignite.internal.processors.cache.local.GridCacheLocalRollbackSelfTest;
...
public class IgniteCacheTestSuite2 {
    ...
    public static List<Class<?>> suite(Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, GridCacheLocalRollbackSelfTest.class, ignoredTests);
