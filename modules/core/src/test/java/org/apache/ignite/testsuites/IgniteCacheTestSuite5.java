...
import org.apache.ignite.internal.processors.cache.ClientSlowDiscoveryTest;
...
public class IgniteCacheTestSuite5 {
    ...
    public static List<Class<?>> suite(Collection<Class> ignoredTests) {
        ...
        GridTestUtils.addTestIfNeeded(suite, ClientSlowDiscoveryTest.class, ignoredTests);
