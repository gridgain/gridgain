...
public class PlatformResumeThreadsTask extends ComputeTaskAdapter<String, Integer> {
    ...
    @NotNull @Override public Map<? extends ComputeJob, ClusterNode> map(List<ClusterNode> subgrid,
        @Nullable String arg) {
        return Collections.singletonMap(new PlatformResumeThreadsJob(arg), F.first(subgrid));
    }
     ...
     * Job.
     */
    private static class PlatformResumeThreadsJob extends ComputeJobAdapter {
         ...
         * @param name Argument.
         */
        public PlatformResumeThreadsJob(String name) {
            this.name = name;
        }
