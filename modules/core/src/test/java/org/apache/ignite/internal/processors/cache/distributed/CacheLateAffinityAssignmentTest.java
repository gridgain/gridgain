...
//    @Test
//    public void testDelayAssignmentAffinityChangedUnexpectedPME2() throws Exception {
//        Ignite ignite0 = startServer(0, 1);
//
//        for (int i = 0; i < 1024; i++)
//            ignite0.cache(CACHE_NAME1).put(i, i);
...
//        DiscoverySpiTestListener lsnr = new DiscoverySpiTestListener();
//
//        TcpDiscoveryNodeAddingSpi disco0 = (TcpDiscoveryNodeAddingSpi)ignite0.configuration().getDiscoverySpi();
//
//        ((IgniteDiscoverySpi)ignite0.configuration().getDiscoverySpi()).setInternalListener(lsnr);
//
//        TestRecordingCommunicationSpi commSpi0 =
...
//
//        // Starting a new server node means that the late affinity assignment message (1) should be skipped.
//        CountDownLatch nodeAddedMsgLatch = new CountDownLatch(1);
//        CountDownLatch blockNodeAddedMsgLatch = new CountDownLatch(1);
//        disco0.interceptor = (msg) -> {
//            log.warning(">>>>> intercept " + msg.node() + " [ msg=" + msg + ']');
//            nodeAddedMsgLatch.countDown();
//
//            try {
//                blockNodeAddedMsgLatch.await();
//            }
...
//        };
//
//        IgniteInternalFuture<?> startServerFut = runAsync(() -> {
//            startServer(3, 4);
//        });
//
//        nodeAddedMsgLatch.await();
//
//        TestRecordingCommunicationSpi clientSpi = new TestRecordingCommunicationSpi();
//        clientSpi.blockMessages(blockSingleExhangeMessage());
//        spiC = igniteInstanceName -> clientSpi;
...
//
//        doSleep(5_000);
//        blockNodeAddedMsgLatch.countDown();
//
//        clientSpi.waitForBlocked();
//
//        // Unblock the late affinity assignment message (1).
