...
public class IgniteClientFailuresTest extends GridCommonAbstractTest {
    ...
    /**
     * Test verifies that when client node failed but not yet cleaned up from topology (because
     * {@link IgniteConfiguration#clientFailureDetectionTimeout} has not been reached yet)
