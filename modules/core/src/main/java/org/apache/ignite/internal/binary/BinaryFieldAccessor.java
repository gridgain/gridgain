...
public abstract class BinaryFieldAccessor {
     ...
     */
    public void write(Object obj, BinaryAbstractWriter writer) throws BinaryObjectException {
        try {
            write0(obj, writer);
        }
     ...
     * @throws BinaryObjectException If failed.
     */
    protected abstract void write0(Object obj, BinaryAbstractWriter writer) throws BinaryObjectException;
     ...
     * @throws BinaryObjectException If failed.
     */
    public void read(Object obj, BinaryAbstractReader reader) throws BinaryObjectException {
        try {
            read0(obj, reader);
        }
        catch (Exception ex) {
     ...
     * @throws BinaryObjectException If failed.
     */
    protected abstract void read0(Object obj, BinaryAbstractReader reader) throws BinaryObjectException;
    ...
    private static class BytePrimitiveAccessor extends AbstractPrimitiveAccessor {
        ...
        /** {@inheritDoc} */
        @Override protected void write0(Object obj, BinaryAbstractWriter writer) throws BinaryObjectException {
        ...
        /** {@inheritDoc} */
        @Override protected void read0(Object obj, BinaryAbstractReader reader) throws BinaryObjectException {
    ...
    private static class DefaultFinalClassAccessor extends BinaryFieldAccessor {
        ...
        /** {@inheritDoc} */
        @Override public void read0(Object obj, BinaryAbstractReader reader) throws BinaryObjectException {
         ...
         */
        protected Object readFixedType(BinaryAbstractReader reader) throws BinaryObjectException {
            Object val = null;
