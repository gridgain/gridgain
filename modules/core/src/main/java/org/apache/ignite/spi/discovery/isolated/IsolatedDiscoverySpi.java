...
public class IsolatedDiscoverySpi extends IgniteSpiAdapter implements IgniteDiscoverySpi {
    ...
    @Override public boolean allNodesSupport(IgniteFeatures feature) {
        return allNodesSupports(((IgniteEx)ignite).context(), singleton(locNode), feature);
    }

    /** {@inheritDoc} */
    @Override public boolean allNodesSupport(IgniteFeatures feature, IgnitePredicate<ClusterNode> predicate) {
