...
public class TaskWithAttributesEvent extends TaskEvent {
     ...
     */
    public TaskWithAttributesEvent(ClusterNode node, String msg, int type, IgniteUuid sesId, String taskName, String taskClsName,
    ...
    @Override public String toString() {
        return S.toString(TaskWithAttributesEvent.class, this,
