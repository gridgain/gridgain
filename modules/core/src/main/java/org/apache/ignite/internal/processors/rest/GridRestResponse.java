...
public class GridRestResponse implements Externalizable {
    ...
    /**
     * @return Action to run after this response is written and flushed to the client, or
     *     {@code null} if none.
     */
    @Nullable public Runnable afterWrite() {
        return afterWrite;
    }

    /**
     * @param afterWrite Action to run after this response is written and flushed to the client
     *     (HTTP/Jetty only).
     */
    public void afterWrite(@Nullable Runnable afterWrite) {
