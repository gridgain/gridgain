 ...
 */
public class GridCacheQueryManager<K, V> extends GridCacheManagerAdapter<K, V> {
    /** */
    ...
    private IgniteBiInClosure<UUID,GridCacheQueryResponse> resHnd = this::processQueryResponse;
