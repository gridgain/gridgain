 ...
 */
public class LegacyBulkLoadProcessor implements AutoCloseable {
     ...
     */
    public LegacyBulkLoadProcessor(BulkLoadParser inputParser, IgniteClosureX<List<?>, IgniteBiTuple<?, ?>> dataConverter,
