...
public class RecordV1Serializer implements RecordSerializer {
    ...
    public static final int HEADER_RECORD_SIZE = REC_TYPE_SIZE + FILE_WAL_POINTER_SIZE + CRC_SIZE +
        RecordDataV1Serializer.HEADER_RECORD_DATA_SIZE;
    ...
    private final RecordIO recordIO = new RecordIO() {
        ...
        /** {@inheritDoc} */
        @Override public WALRecord readWithHeaders(ByteBufferBackedDataInput in,
            WALPointer expPtr) throws IOException, IgniteCheckedException {
