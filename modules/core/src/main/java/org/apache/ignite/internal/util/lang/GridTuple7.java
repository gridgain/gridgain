 ...
 */
public class GridTuple7<V1, V2, V3, V4, V5, V6, V7> implements Iterable<Object>, Externalizable,
    Cloneable {
    /** */
     ...
     */
    public GridTuple7(@Nullable V1 v1, @Nullable V2 v2, @Nullable V3 v3, @Nullable V4 v4, @Nullable V5 v5,
                      @Nullable V6 v6, @Nullable V7 v7) {
        this.v1 = v1;
        this.v2 = v2;
        this.v3 = v3;
        this.v4 = v4;
     ...
     * Sets sixth value.
     *
     * @param v7 Sixth value.
     */
    public void set7(@Nullable V7 v7) {
        this.v7 = v7;
    }
    ...
    public void set(@Nullable V1 val1, @Nullable V2 val2, @Nullable V3 val3, @Nullable V4 val4, @Nullable V5 val5,
        @Nullable V6 val6, @Nullable V7 val7) {
        set1(val1);
        set2(val2);
        set3(val3);
        set4(val4);
    ...
    @Override public boolean equals(Object o) {
        ...
        GridTuple7<?, ?, ?, ?, ?, ?, ?> t = (GridTuple7<?, ?, ?, ?, ?, ?, ?>)o;

        return F.eq(v1, t.v1) && F.eq(v2, t.v2) && F.eq(v3, t.v3) && F.eq(v4, t.v4) && F.eq(v5, t.v5) && F.eq(v6, t.v6) && F.eq(v7, t.v7);
    }
    ...
    @Override public int hashCode() {
        ...
        res = 41 * res + (v7 != null ? v7.hashCode() : 0);
    ...
    @Override public String toString() {
        return S.toString(GridTuple7.class, this);
    }
}