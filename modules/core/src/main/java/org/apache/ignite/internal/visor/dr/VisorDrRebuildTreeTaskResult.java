 ...
 *
 */
public class VisorDrRebuildTreeTaskResult extends IgniteDataTransferObject {
    /** Serial version uid. */
     ...
     * Default constructor.
     */
    public VisorDrRebuildTreeTaskResult() {
    }
     ...
     */
    VisorDrRebuildTreeTaskResult(boolean success, String message) {
     ...
     */
    VisorDrRebuildTreeTaskResult(List<String> failures) {
