 ...
 */
public class SqlAnalyzeCommand implements SqlCommand {
    /** */
    private static final String ASYNC = "ASYNC";

    /** */
    private static final String EXPECTED_GLOBAL_QRY_ID_FORMAT = "Analyze command should have format " +
        "ANALYZE TABLE [{SCHEMA_NAME}.]{TABLE_NAME} COMPUTE STATISTICS [FOR COLUMNS {COL_NAMES}], " +
            "e.g. ANALYZE TABLE PUBLIC.CUSTOMERS COMPUTE STATISTICS FOR COLUMNS USER_NAME, AGE, FIRST_NAME";
