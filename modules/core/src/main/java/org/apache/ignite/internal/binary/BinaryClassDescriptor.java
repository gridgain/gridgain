...
public class BinaryClassDescriptor {
     ...
     * @throws BinaryObjectException In case of error.
     */
    void write(Object obj, BinaryAbstractWriter writer) throws BinaryObjectException {
        try {
            assert obj != null;
            assert writer != null;
     ...
     */
    Object read(BinaryAbstractReader reader) throws BinaryObjectException {
        try {
            assert reader != null;
            assert mode != BinaryWriteMode.OPTIMIZED : "OptimizedMarshaller should not be used here: " + cls.getName();
     ...
     */
    private boolean preWrite(BinaryAbstractWriter writer, Object obj) {
     ...
     * @param writer Writer.
     */
    private void postWrite(BinaryAbstractWriter writer) {
     ...
     * @param obj Object.
     */
    private void postWriteHashCode(BinaryAbstractWriter writer, Object obj) {
