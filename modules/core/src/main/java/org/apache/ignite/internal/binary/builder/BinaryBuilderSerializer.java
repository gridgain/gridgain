...
class BinaryBuilderSerializer {
     ...
     * @param val Value.
     */
    public void writeValue(BinaryAbstractWriterEx writer, Object val) {
     ...
     */
    public void writeValue(BinaryAbstractWriterEx writer, Object val, boolean forceCol, boolean forceMap) {
     ...
     */
    public void writeArray(BinaryAbstractWriterEx writer, byte elementType, Object[] arr, int compTypeId) {
     ...
     */
    public void writeArray(BinaryAbstractWriterEx writer, byte elementType, Object[] arr, String clsName) {
        writer.writeByte(elementType);
