...
class BinaryBuilderSerializer {
     ...
     * @param val Value.
     */
    public void writeValue(BinaryAbstractWriter writer, Object val) {
     ...
     */
    public void writeValue(BinaryAbstractWriter writer, Object val, boolean forceCol, boolean forceMap) {
     ...
     */
    public void writeArray(BinaryAbstractWriter writer, byte elementType, Object[] arr, int compTypeId) {
     ...
     */
    public void writeArray(BinaryAbstractWriter writer, byte elementType, Object[] arr, String clsName) {
        writer.writeByte(elementType);
