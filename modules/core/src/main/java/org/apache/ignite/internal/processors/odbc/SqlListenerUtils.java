...
public abstract class SqlListenerUtils {
     ...
     */
    @Nullable public static Object readObject(BinaryAbstractReader reader, boolean binObjAllow)
     ...
     * @throws BinaryObjectException On error.
     */
    public static void writeObject(BinaryAbstractWriter writer, @Nullable Object obj, boolean binObjAllow)
        throws BinaryObjectException {
        if (obj == null) {
