...
import static org.apache.ignite.internal.processors.cache.persistence.diagnostic.pagelocktracker.PageLockTrackerFactory.TRACKING_DISABLED;
...
public final class IgniteSystemProperties {
    ...
    @SystemProperty(value = "When set to positive number warning will be produced when outgoing message queue size of " +
        "TCP communication SPI exceeds provided value. Default is 0 (do not print warning).", type = Integer.class)
