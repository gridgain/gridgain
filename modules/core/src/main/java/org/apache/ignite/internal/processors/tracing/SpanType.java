...
public enum SpanType {
    ...
    /** */
    CACHE_API_GET(Scope.CACHE_API_READ, "cache.api.get", 66, true),

    /** */
    CACHE_API_GET_ALL(Scope.CACHE_API_READ, "cache.api.get.all", 67, true),

    /** */
    CACHE_API_GET_ASYNC(Scope.CACHE_API_READ, "cache.api.get.async", 68, true),

    /** */
    CACHE_API_GET_ALL_ASYNC(Scope.CACHE_API_READ, "cache.api.get.all.async", 69, true),

    /** */
    CACHE_API_NEAR_GET_FUTURE(Scope.CACHE_API_READ, "cache.api.near.get.future", 70, false),

    /** */
    CACHE_API_PARTITIONED_GET_FUTURE(Scope.CACHE_API_READ, "cache.api.partitioned.get.future", 71, false),

    /** */
    CACHE_API_PARTITIONED_SINGLE_GET_FUTURE(Scope.CACHE_API_READ, "cache.api.partitioned.single.get.future", 72, false),

    /** */
    CACHE_API_DHT_GET_FUTURE(Scope.CACHE_API_READ, "cache.api.dht.get.future", 73, false),

    /** */
    CACHE_API_DHT_SINGLE_GET_FUTURE(Scope.CACHE_API_READ, "cache.api.dht.single.get.future", 74, false),

    /** */
    CACHE_API_NEAR_GET_MAP(Scope.CACHE_API_READ, "cache.api.near.get.map", 75, false),

    /** */
    CACHE_API_PARTITIONED_GET_MAP(Scope.CACHE_API_READ, "cache.api.partitioned.get.map", 76, false),

    /** */
    CACHE_API_PARTITIONED_SINGLE_GET_MAP(Scope.CACHE_API_READ, "cache.api.partitioned.single.get.map", 77, false),

    /** */
    CACHE_API_PARTITIONED_SINGLE_GET_WAIT_AND_REMAP(Scope.CACHE_API_READ,
        "cache.api.partitioned.single.get.wait.and.remap", 78, false),

    /** */
    CACHE_API_PARTITIONED_SINGLE_GET_REMAP(Scope.CACHE_API_READ, "cache.api.partitioned.single.get.remap", 79, false),

    /** */
    CACHE_API_DHT_GET_MAP(Scope.CACHE_API_READ, "cache.api.dht.get.map", 80, false),

    /** */
    CACHE_API_DHT_SINGLE_GET_MAP(Scope.CACHE_API_READ, "cache.api.dht.single.get.map", 81, false),

    /** */
    CACHE_API_NEAR_PROCESS_ATOMIC_GET_REQUEST(Scope.CACHE_API_READ, "cache.api.near.atomic.get.request", 82, false),

    /** */
    CACHE_API_NEAR_PROCESS_ATOMIC_GET_RESPONSE(Scope.CACHE_API_READ, "cache.api.near.atomic.get.response", 83, false),

    /** */
    CACHE_API_NEAR_PROCESS_ATOMIC_SINGLE_GET_REQUEST(Scope.CACHE_API_READ,
        "cache.api.near.atomic.single.get.request", 84, false),

    /** */
    CACHE_API_NEAR_PROCESS_ATOMIC_SINGLE_GET_RESPONSE(Scope.CACHE_API_READ,
        "cache.api.near.atomic.single.get.response", 85, false);
