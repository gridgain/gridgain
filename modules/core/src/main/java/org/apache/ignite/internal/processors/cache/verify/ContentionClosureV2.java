...
/**
 */
public class ContentionClosureV2 implements IgniteCallable<ContentionInfo> {
    /** Serial version uid. */
     ...
     */
    public ContentionClosureV2(int minQueueSize, int maxPrint) {
     ...
     * @param maxPrint Max entries to print.
     */
    public ContentionClosureV2(int minQueueSize, int maxPrint, IgniteEx ig) {
        this.minQueueSize = minQueueSize;
        this.maxPrint = maxPrint;
