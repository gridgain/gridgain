...
public class BinaryArrayIdentityResolver extends BinaryAbstractIdentityResolver {
    ...
    public static int compare0(BinaryObject o1, BinaryObject o2) {
        if (o1 instanceof BinaryObjectEx && o2 instanceof BinaryObjectEx) {
            ...
            int r = Integer.compare(ex1.typeId(), ex2.typeId());
            ...
            if (ex1 instanceof BinaryObjectExImpl) {
                ...
                if (exx1.hasArray())
                    return exx2.hasArray() ? compareHeap(exx1, exx2) : compareHeapOffheap(exx1, exx2);
                else
                    return exx2.hasArray() ? -1 * compareHeapOffheap(exx2, exx1) : compareOffheap(exx1, exx2);
            }
            else {
                // Handle enums.
                assert ex1 instanceof BinaryEnumObjectImpl;
                ...
                return Integer.compare(ex1.enumOrdinal(), ex2.enumOrdinal());
            }
        }
    ...
    /** */
    private static int compareHeapOffheap(BinaryObjectExImpl o1, BinaryObjectExImpl o2) {
        throw new RuntimeException("Not supported");
    }

    /** */
    private static int compareOffheap(BinaryObjectExImpl o1, BinaryObjectExImpl o2) {
        throw new RuntimeException("Not supported");
    }
     ...
     * @return Result.
     */
    private static int compareHeap(BinaryObjectExImpl o1, BinaryObjectExImpl o2) {
        byte[] arr1 = o1.array();
        byte[] arr2 = o2.array();
        ...
        for (int step = 0; step < commonLen; i++, j++, step++) {
            byte b = arr1[i];
            byte b2 = arr2[j];
