...
public class JdbcUtils {
     ...
     */
    public static void writeItems(BinaryAbstractWriter writer, List<List<Object>> items) {
     ...
     */
    public static List<List<Object>> readItems(BinaryAbstractReader reader) {
     ...
     */
    public static void writeStringCollection(BinaryAbstractWriter writer, Collection<String> lst) {
        if (lst == null)
            writer.writeInt(0);
        else {
     ...
     */
    public static List<String> readStringList(BinaryAbstractReader reader) {
     ...
     * @return read value.
     */
    @Nullable public static Integer readNullableInteger(BinaryAbstractReader reader) {
     ...
     */
    public static void writeNullableInteger(BinaryAbstractWriter writer, @Nullable Integer val) {
     ...
     * @param val Integer value..
     */
    public static void writeNullableLong(BinaryAbstractWriter writer, @Nullable Long val) {
        writer.writeBoolean(val != null);
