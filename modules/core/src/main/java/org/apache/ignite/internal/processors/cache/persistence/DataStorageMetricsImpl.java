...
public class DataStorageMetricsImpl implements DataStorageMetricsMXBean {
    ...
    /** */
    private final HistogramMetric cpBeforeLockHistogram;

    /** */
    private final HistogramMetric cpLockWaitHistogram;

    /** */
    private final HistogramMetric cpListenersExecuteHistogram;

    /** */
    private final HistogramMetric cpMarkHistogram;

    /** */
    private final HistogramMetric cpLockHoldHistogram;

    /** */
    private final HistogramMetric cpPagesWriteHistogram;

    /** */
    private final HistogramMetric cpFsyncHistogram;

    /** */
    private final HistogramMetric cpWalRecordFsyncHistogram;

    /** */
    private final HistogramMetric cpWriteEntryHistogram;

    /** */
    private final HistogramMetric cpSplitAndSortPagesHistogram;

    /** */
    private final HistogramMetric cpHistogram;
