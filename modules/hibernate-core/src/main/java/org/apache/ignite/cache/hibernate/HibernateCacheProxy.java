...
public class HibernateCacheProxy implements IgniteInternalCache<Object, Object> {
    ...
    /** {@inheritDoc} */
    @Override public IgniteInternalFuture<Boolean> touchAsync(Object key) {
        return delegate.get().touchAsync(keyTransformer.transform(key));
    }
    ...
    @Override public Iterator<Cache.Entry<Object,Object>> scanIterator(
        ...
        return delegate.get().scanIterator(keepBinary, p, timeout);
    }
